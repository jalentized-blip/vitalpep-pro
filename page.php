...
while ( have_posts() ) :
    ...
    // FlexPens — include content directly, no filters or routing needed
    if ( $post->post_name === 'flexpens' ) {
                ...
                <div class="fp-product__grid<?php echo $p['reverse'] ? ' fp-product__grid--reverse' : ''; ?>">
                    ...
                    <div class="fp-animate fp-animate--delay1">
                        ...
                        <div class="fp-specs">
                            ...
                            <div class="fp-spec"><div class="fp-spec__val">2&ndash;8&deg;C</div><div class="fp-spec__label">Storage</div></div>
                        </div>
        ...
        (function(){
            ...
            function update(){var y=window.scrollY||window.pageYOffset,a=sections[0];sections.forEach(function(s){if(y>=s.el.offsetTop-120)a=s;});links.forEach(function(l){l.classList.remove('active');});if(a)a.link.classList.add('active');}
            window.addEventListener('scroll',update,{passive:true});
            links.forEach(function(l){l.addEventListener('click',function(e){e.preventDefault();var el=document.getElementById(l.getAttribute('data-target'));if(el)window.scrollTo({top:el.offsetTop-80,behavior:'smooth'});});});
        })();
        </script>
    ...
    <?php } else { ?>
        ...
        <section class="page-hero">
            ...
            <div class="container">
                ...
                <?php if ( has_excerpt() ) : ?>
                    <p class="page-hero__subtitle"><?php echo get_the_excerpt(); ?></p>
                <?php endif; ?>
            </div>
        </section>
